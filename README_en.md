...
The repository includes a real-environment test script that does not require the AstrBot main process: `tests/real_cloudcli_command_test.py`. It injects a fake AstrBot context, loads the plugin class, then connects to a real CloudCLI server and tests the command flow.
